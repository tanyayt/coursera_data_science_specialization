...
## ------UPDATING ---------Create body_acc_x_mean and body_acc_x_sd 
...
body_acc_x_mean<-as.data.frame(body_acc_x_mean)
colnames(body_acc_x_mean)<-c("body_acc_x_mean")

#next, sd----------------START HERE
body_acc_x<-as.matrix(body_acc_x)
class(body_acc_x)
```
